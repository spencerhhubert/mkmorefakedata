...
def visualize_algo(config: Config, algorithm: Algorithm, save_path: str = None) -> None:
...
def visualize_multiple_algos(config: Config, algorithms: List[Algorithm], rows: int = 2, cols: int = 3) -> None:
